...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/10 06:09:59 by tsedigi           #+#    #+#             */
/*   Updated: 2018/08/10 06:10:00 by tsedigi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char				get_type_32_big(struct nlist *table)
{
	unsigned char		c;
...
int						add_table_32_big(struct nlist table, char *stringtable)
{
	...
	if (table.n_value)
		...
		t->show = 0;
	t->value = swap_uint32(table.n_value);
	t->archi = 32;
	t->type = get_type_32_big(&table);
