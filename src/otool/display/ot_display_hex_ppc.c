...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ot_display_hex_ppc.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tsedigi <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/07 02:47:24 by tsedigi           #+#    #+#             */
/*   Updated: 2018/09/07 02:47:25 by tsedigi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ot_display_hex_ppc(void *data,
	unsigned long size, unsigned long addr, int pad)
{
	char			*str_adr;
	unsigned long	i;
	int				j;
